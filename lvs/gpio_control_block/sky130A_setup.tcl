...
set devices {sky130_fd_sc_hd__tapvpwrvgnd_1 sky130_fd_sc_hd__fill_2 sky130_fd_sc_hd__fill_1 ky130_fd_pr__model__parasitic__diode_ps2nw sky130_fd_io__condiode sky130_fd_io__tap_1}
...
# Match the following library equivalents:
#
# x2l_sky130_fd_sc_hd = sky130_fd_sc_hd
# mM_sky130_fd_sc_hd = sky130_fd_sc_hd
# DH_sky130_fd_sc_hvl = sky130_fd_sc_hvl

foreach cell $cells2 {
    if {[regexp {(sky130_fd_sc_hd__.+)} $cell match]} {
	if {[lsearch $cells1 x2l_$cell] >= 0} {
	   equate classes "-circuit1 x2l_$cell" "-circuit2 $cell"
	}
	if {[lsearch $cells1 mM_$cell] >= 0} {
	   equate classes "-circuit1 mM_$cell" "-circuit2 $cell"
	}
    }
    if {[regexp {(sky130_fd_sc_hvl__.+)} $cell match]} {
	if {[lsearch $cells1 DH_$cell] >= 0} {
	   equate classes "-circuit1 DH_$cell" "-circuit2 $cell"
	}
    }
    if {[regexp {(sky130_fd_io__.+)} $cell match]} {
	if {[lsearch $cells1 x9k_$cell] >= 0} {
	   equate classes "-circuit1 x9k_$cell" "-circuit2 $cell"
	}
    }
}
