...
set ::env(CELL_PAD) "8"
set ::env(MERGED_LEF) "/project/openlane/gpio_control_block/runs/gpio_control_block/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/gpio_control_block/runs/gpio_control_block/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/gpio_control_block/runs/gpio_control_block/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/home/xrex/usr/devel/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef"
# Design config
set ::env(CLOCK_PERIOD) "10"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/gpio_control_block/runs/gpio_control_block/tmp/trimmed.lib"
...
set ::env(CURRENT_DEF) /project/openlane/gpio_control_block/runs/gpio_control_block/results/routing/gpio_control_block.def
set ::env(CURRENT_NETLIST) /project/openlane/gpio_control_block/runs/gpio_control_block/results/lvs/gpio_control_block.lvs.powered.v
set ::env(PREV_NETLIST) /project/openlane/gpio_control_block/runs/gpio_control_block/results/synthesis/gpio_control_block.synthesis_preroute.v
