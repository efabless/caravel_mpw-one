...
set ::env(CELL_PAD) "0"
set ::env(MERGED_LEF) "/project/openlane/user_id_programming/runs/user_id_programming/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/user_id_programming/runs/user_id_programming/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/user_id_programming/runs/user_id_programming/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/home/xrex/usr/devel/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef"
# Design config
set ::env(CLOCK_PERIOD) "10"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/user_id_programming/runs/user_id_programming/tmp/trimmed.lib"
...
set ::env(CURRENT_DEF) /project/openlane/user_id_programming/runs/user_id_programming/results/routing/user_id_programming.def
set ::env(CURRENT_NETLIST) /project/openlane/user_id_programming/runs/user_id_programming/results/lvs/user_id_programming.lvs.powered.v
set ::env(PREV_NETLIST) /project/openlane/user_id_programming/runs/user_id_programming/results/synthesis/user_id_programming.synthesis_preroute.v
