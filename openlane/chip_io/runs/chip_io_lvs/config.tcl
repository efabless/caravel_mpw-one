...
set ::env(CELL_PAD) "8"
set ::env(MERGED_LEF) "/project/openlane/chip_io/runs/chip_io_lvs/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/chip_io/runs/chip_io_lvs/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/chip_io/runs/chip_io_lvs/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/home/xrex/usr/devel/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef"
# Design config
set ::env(CLOCK_PERIOD) "10"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/chip_io/runs/chip_io_lvs/tmp/trimmed.lib"
...
set ::env(CURRENT_DEF) /project/openlane/chip_io/runs/chip_io_lvs/tmp/floorplan/verilog2def_openroad.def
set ::env(CURRENT_NETLIST) /project/openlane/chip_io/runs/chip_io_lvs/results/synthesis/chip_io.synthesis.v
