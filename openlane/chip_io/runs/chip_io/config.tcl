...
set ::env(CURRENT_DEF) /project/openlane/chip_io/runs/chip_io/results/routing/chip_io.def
set ::env(CURRENT_NETLIST) /project/openlane/chip_io/runs/chip_io/results/synthesis/chip_io.synthesis.v
set ::env(PREV_NETLIST) /project/openlane/chip_io/runs/chip_io_lvs/results/synthesis/chip_io.synthesis.v
