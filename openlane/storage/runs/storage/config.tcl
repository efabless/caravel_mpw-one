...
set ::env(CELL_PAD) "8"
set ::env(MERGED_LEF) "/project/openlane/storage/runs/storage/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/storage/runs/storage/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/storage/runs/storage/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/home/xrex/usr/devel/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef"
# Design config
set ::env(CLOCK_PERIOD) "50"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/storage/runs/storage/tmp/trimmed.lib"
...
set ::env(CURRENT_DEF) /project/openlane/storage/runs/storage/results/routing/storage.def
set ::env(CURRENT_NETLIST) /project/openlane/storage/runs/storage/results/lvs/storage.lvs.powered.v
set ::env(PREV_NETLIST) /project/openlane/storage/runs/storage/results/synthesis/storage.synthesis_preroute.v
