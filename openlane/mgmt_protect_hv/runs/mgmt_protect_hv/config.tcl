...
set ::env(CELL_PAD) "0"
set ::env(MERGED_LEF) "/project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/home/xrex/usr/devel/pdks/sky130A/libs.ref/sky130_fd_sc_hvl/techlef/sky130_fd_sc_hvl.tlef"
# Design config
set ::env(CLOCK_PERIOD) "10"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/tmp/trimmed.lib"
...
set ::env(CURRENT_DEF) /project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/results/routing/mgmt_protect_hv.def
set ::env(CURRENT_NETLIST) /project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/results/lvs/mgmt_protect_hv.lvs.powered.v
set ::env(PREV_NETLIST) /project/openlane/mgmt_protect_hv/runs/mgmt_protect_hv/results/synthesis/mgmt_protect_hv.synthesis_preroute.v
